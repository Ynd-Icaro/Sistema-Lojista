...
export class RegisterDto {
  ...
  @ApiPropertyOptional({
    example: "tenant-uuid",
    description: "ID da empresa existente (opcional)",
  })
  @IsString()
  @IsOptional()
  tenantId?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: "Nome da nova empresa (cria um tenant novo)",
  })
  @IsString()
  @MinLength(3, {
  ...
  @IsEnum(["ADMIN", "MANAGER", "SELLER", "VIEWER"], {
    message: "O papel deve ser ADMIN, MANAGER, SELLER ou VIEWER",
  })
  @IsOptional()
  role?: string;
}
