...
export class ProductsController {
  ...
  @ApiOperation({
    summary: "Vincular produtos como variações de um produto principal",
  })
  linkVariations(
    @CurrentUser("tenantId") tenantId: string,
    @Body() dto: LinkVariationDto,
  ) {
    return this.importExportService.linkVariations(
      tenantId,
      dto.parentProductId,
      dto.variationIds,
    );
  ...
  unlinkVariations(
    @CurrentUser("tenantId") tenantId: string,
    @Body() dto: UnlinkVariationDto,
  ) {
    return this.importExportService.unlinkVariations(
      tenantId,
      dto.variationIds,
    );
  }
