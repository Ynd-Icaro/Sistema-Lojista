...
export class CreateCustomerDto {
  ...
  @ApiPropertyOptional({ example: 'PF', enum: ['PF', 'PJ'], description: 'Tipo de pessoa (PF ou PJ)' })
  ...
  @ApiPropertyOptional({ example: '48999999999', description: 'Telefone do cliente' })
  @IsString({ message: 'Telefone deve ser uma string' })
  @IsOptional()
  phone?: string;

  @ApiPropertyOptional({ example: '48999999999', description: 'WhatsApp do cliente' })
  @IsString({ message: 'WhatsApp deve ser uma string' })
  @IsOptional()
  whatsapp?: string;

  @ApiPropertyOptional({ example: '000.000.000-00', description: 'CPF ou CNPJ do cliente' })
  ...
  @ApiPropertyOptional({ example: 'M', enum: ['M', 'F', 'O'], description: 'Gênero' })
